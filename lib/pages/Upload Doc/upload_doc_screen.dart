      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            Obx(() =>
            uploadedDocList.value != null ? uploadedDocList.value.isNotEmpty ?
            ListView.builder(
                  ...
                  child: Material(
                    ...
                    child: ListTile(
                      ...
                      subtitle: Column(
                        ...
                        children: [
                          SizedBox(height: 5,),
                          Text("Uploaded on : ${uploadedDocList.value[index]
                              .createdAt.toString()
                              .padLeft(10)}"),
                          Row(
                            children: [
                      ...
                      trailing: Column(
                        ...
                        children: [
                          ...
                          GestureDetector(
                            onTap: () async {
                              _launchUrl(uploadedDocList.value[index].fileName);
                              debugPrint(uploadedDocList.value[index].fileName);
                      ...
                      children: [
                        ...
                        Container(
                          width: MediaQuery
                              ...
                              .width / 2,
                          child: Obx(() =>
                              Text(filesname.value, style: TextStyle(
...
// debugPrint(selectedDocType.value);
  ...
  void getAllUploadedDoc() async {
    ...
    if (res.statusCode == 200) {
      UploadedDocumentModal modal = UploadedDocumentModal.fromJson(
          jsonDecode(res.body));
      setState(() {
