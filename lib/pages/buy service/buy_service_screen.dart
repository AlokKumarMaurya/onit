                    ...
                    child: ListTile(
                      ...
                      subtitle: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 5,),
                          Text("Created at: ${DateFormat.yMMMMd().format(DateTime.parse(serviceList.createdAt))}",
                              style: const TextStyle(
                                  fontSize: 12,
                                  color: Colors.grey,
                                  fontWeight: FontWeight.bold)),
                          SizedBox(height: 5,),
                          Text("Updated at: ${DateFormat.yMMMMd().format(DateTime.parse(serviceList.updatedAt))}",
                              style: const TextStyle(
                                  fontSize: 12,
                                  color: Colors.grey,
                                  fontWeight: FontWeight.bold)),
                      ...
                      trailing: Column(
                        ...
                        children: [
                          ...
                          GestureDetector(
                            onTap: () async {
                              if(serviceList.status=="0" || serviceList.status==0){
                                Fluttertoast.showToast(msg: "You already purchased this serivce");
                              }else {
                                setState(() {
                                ...
                                razorPayPayment(
                                    amount: int.parse(serviceList.price),
