...
class AppRoutes{
  ...
  static const forgetPasswordScreen = "lib/pages/auth/forget_Password/forget_password_screen.dart";
  static const registrationScreen = "lib/pages/auth/user_registration/registration_Screen.dart";
...
appGeneratedRoutes(RouteSettings settings) {
  switch (settings.name) {
    ...
    case AppRoutes.otpScreen:
      String user_name = "";
      try {
        user_name = settings.arguments as String ;
      } catch (e) {}
      return MaterialPageRoute(
          settings:
          RouteSettings(name: settings.name, arguments: settings.arguments),
...
case AppRoutes.splashPage:
      return MaterialPageRoute(
          settings:
          RouteSettings(name: settings.name, arguments: settings.arguments),
          builder: (BuildContext context) => const SplashPage()); //homePage
